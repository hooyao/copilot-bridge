# agent-repository-compatibility Specification

## Purpose
Define how one canonical repository constitution, parity-checked project skills,
and secret-safe local configuration provide equivalent Claude Code and Codex
agent workflows after a fresh clone.
## Requirements
