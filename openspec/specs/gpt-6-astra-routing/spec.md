# gpt-6-astra-routing Specification

## Purpose

Define exact Copilot GPT-6 Astra support and the compatibility route that lets a reviewed GPT-5.6 Sol Codex client identity use Astra safely, including effort migration, route-aware catalog limits, native Responses fidelity, and real-client acceptance evidence.
