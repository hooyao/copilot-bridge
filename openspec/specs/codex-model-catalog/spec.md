...
Define how the bridge exposes a version-compatible Codex-native model catalog,
safely overlays validated GitHub Copilot backend capacity, activates discovery
without leaking credentials, and degrades to reviewed limits without disabling
otherwise healthy Codex inference.
