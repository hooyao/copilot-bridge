# codex-astra-vision-verification Specification

## Purpose

Verify native Codex attachments and image-tool results through the stock Astra route using image-derived answers, completed tool execution, and client-owned logs. Preserve native tool-output content while keeping the Copilot vision header consistent with actual image parts.
