...
/// the value from the registration order. Injecting a singleton into a scoped
/// detector is safe (the unsafe direction is scoped→singleton). AOT-clean: the
/// closed generic is known at compile time at both the registration and injection
/// sites.
/// </remarks>
