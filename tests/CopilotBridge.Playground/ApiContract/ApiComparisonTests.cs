...
///
/// Current model mapping: Anthropic native uses <c>claude-opus-5-5</c>;
/// Copilot advertises <c>claude-opus-5.5</c>. Both serve 1M context.
/// </summary>
...
public class ApiComparisonTests
{
    ...
    [InlineData("claude-opus-5.5", "claude-opus-5-5", null, "opus-5.5 (both)")]
    [InlineData("claude-opus-5.5", "claude-opus-5-5", "context-1m-2025-08-07", "opus-5.5 native 1M")]
